...
export class Feedback extends Component {
  ...
  render() {
    return <section className="feedback-area-two ptb-120 bg-38d16a">
          ...
          >
            <div className="col-lg-12">
              <div className="single-feedback center-feedback-box">
                ...
                <p>"Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis. Consectetur adipiscing elit, sed do eiusmod tempor
