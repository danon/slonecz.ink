      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-4 col-md-6">
            <div className="single-blog-post">
              ...
              <div className="blog-post-content">
                ...
                <a href="#" className="read-more-btn">Read More <i className="icofont-double-right"/></a>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-4 col-md-6">
            <div className="single-blog-post">
              <div className="blog-image">
                <a href="#"><img src="/images/blog-image/2.jpg" alt="image"/></a>
          ...
          <div className="col-lg-4 col-md-6">
            <div className="single-blog-post">
              <div className="blog-image">
                <a href="#"><img src="/images/blog-image/3.jpg" alt="image"/></a>
          ...
          <div className="col-lg-4 col-md-6">
            <div className="single-blog-post">
              <div className="blog-image">
                <a href="#"><img src="/images/blog-image/4.jpg" alt="image"/></a>
          ...
          <div className="col-lg-4 col-md-6">
            <div className="single-blog-post">
              <div className="blog-image">
                <a href="#"><img src="/images/blog-image/5.jpg" alt="image"/></a>
          ...
          <div className="col-lg-4 col-md-6">
            <div className="single-blog-post">
              <div className="blog-image">
                <a href="#"><img src="/images/blog-image/6.jpg" alt="image"/></a>
          ...
          <div className="col-lg-4 col-md-6">
            <div className="single-blog-post">
              <div className="blog-image">
                <a href="#"><img src="/images/blog-image/7.jpg" alt="image"/></a>
