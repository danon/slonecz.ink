...
class ComingSoon extends Component {
  ...
  comingSoonTime = () => {
    let endTime = new Date("November 1, 2021 17:00:00 PDT");
          ...
          <div className="d-table-cell">
            <div className="container">
              <div className="coming-soon-content">
                ...
                <div id="timer">
                  <div id="days">{this.state.days}
                    <span>Days</span>
                  </div>
                  <div id="hours">{this.state.hours}
                    <span>Hours</span>
                  </div>
                  <div id="minutes">{this.state.minutes}
                    <span>Minutes</span>
                  </div>
                  <div id="seconds">{this.state.seconds}
                    <span>Seconds</span>
                  </div>
                </div>
