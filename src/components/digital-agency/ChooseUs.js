...
export class ChooseUs extends Component {
  render() {
    return <section className="why-choose-us-area ptb-120">
        ...
        <div className="row h-100 align-items-center">
          ...
          <div className="col-lg-6 col-md-12">
            <div className="why-choose-us-content">
              ...
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices
                gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
                ut.</p>
