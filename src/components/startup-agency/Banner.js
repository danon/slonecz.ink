                                    ...
                                    <div className="row h-100 align-items-center">
                                        <div className="col-lg-7 col-md-12">
                                            <div className="hero-image">
                                                <img src="/images/startup-agency-slider/1.jpg" alt="image" />
                                            </div>
                                        </div>
                            ...
                            <div className="d-table-cell">
                                <div className="container">
                                    <div className="row h-100 align-items-center">
                                        <div className="col-lg-7 col-md-12">
                                            <div className="hero-image">
                                                <img src="/images/startup-agency-slider/2.jpg" alt="image" />
                                            </div>
                                        </div>
                            ...
                            <div className="d-table-cell">
                                <div className="container">
                                    <div className="row h-100 align-items-center">
                                        <div className="col-lg-7 col-md-12">
                                            <div className="hero-image">
                                                <img src="/images/startup-agency-slider/3.jpg" alt="image" />
                                            </div>
                                        </div>
